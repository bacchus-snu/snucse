    ...
    return (
      <div id="login-background">
        <div id="login-box-container">
          <div id="login-github">
            <a
              href="https://github.com/bacchus-snu/snucse"
              target="_blank"
          ...
          <div id="login-box">
            ...
            <section id="login-box-footer">
              <a
                className="login-box-footer-link"
                href="https://www.snucse.org/sign-up"
                target="_blank"
                rel="noopener noreferrer"
              >
                가입 신청하기
              ...
              <a
                className="login-box-footer-link"
                href="https://id.snucse.org/password"
                target="_blank"
                rel="noopener noreferrer"
              >
                비밀번호 찾기
              ...
              <a
                className="login-box-footer-link"
                href="https://id.snucse.org/Privacy.aspx"
                target="_blank"
                rel="noopener noreferrer"
              >
                개인정보 처리방침
      ...
      <form id="login-form" onSubmit={this.handleLogin}>
        <div id="login-input-container">
          <div className="login-form-group">
            <label className="login-form-label" htmlFor="login-username-input">
              아이디
            </label>
            <div className="login-form-input-container">
              <input
                ...
                type="text"
                autoFocus
                ref={genRefCallback(this, "id")}
              />
            </div>
          </div>
          <div className="login-form-group">
            <label className="login-form-label" htmlFor="login-password-input">
              비밀번호
            </label>
            <div className="login-form-input-container">
              <input
                ...
                className="login-form-input"
                type="password"
                ref={genRefCallback(this, "password")}
              />
            </div>
          </div>
        </div>
